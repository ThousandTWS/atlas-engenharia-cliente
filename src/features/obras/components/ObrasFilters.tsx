        ...
        <Row gutter={[16, 0]}>
          ...
          <Col xs={24} sm={12} md={6}>
            <Form.Item name="endereco" label="Endereço">
              <Input style={getFilterControlStyle(isDarkMode)} placeholder="Endereço da obra" allowClear />
            </Form.Item>
          </Col>
          <Col xs={24} sm={12} md={6}>
            <Form.Item name="servico" label="Serviço">
              <Input style={getFilterControlStyle(isDarkMode)} placeholder="Tipo de serviço" allowClear />
            </Form.Item>
          </Col>
          <Col xs={24} sm={12} md={6}>
