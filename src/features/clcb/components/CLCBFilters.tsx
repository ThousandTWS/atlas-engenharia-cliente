        ...
        <Row gutter={[16, 0]}>
          <Col xs={24} sm={12} md={6}>
            <Form.Item name="codigo" label="Código">
              <Input style={{padding:'7px',background: isDarkMode ? '#171C2A' : '#fff', border: isDarkMode ? 'none' : 'solid 1px #CBD5E1'}} placeholder="Buscar por código" allowClear />
            </Form.Item>
          </Col>
          <Col xs={24} sm={12} md={6}>
          ...
          <Col xs={24} sm={12} md={6}>
            <Form.Item name="nf" label="Nota Fiscal">
              <Input style={{padding:'7px',background: isDarkMode ? '#171C2A' : '#fff', border: isDarkMode ? 'none' : 'solid 1px #CBD5E1'}} placeholder="Número da NF" allowClear />
            </Form.Item>
          </Col>
          <Col xs={24} sm={12} md={6}>
            <Form.Item  name="periodo" label="Período do Contrato">
              <RangePicker  style={{ padding:'7px',width: '100%', background: isDarkMode ? '#171C2A' : '#fff', border: isDarkMode ? 'none' : 'solid 1px #CBD5E1' }} format="DD/MM/YYYY" />
            </Form.Item>
          </Col>
        </Row>
        <Row justify="end">
