        ...
        <Row gutter={[16, 0]}>
          <Col xs={24} sm={12} md={8}>
            <Form.Item name="codigo" label="Código">
              <Input placeholder="Buscar por código" allowClear style={{padding:7,background: isDarkMode ? '#171C2A' : '#fff', border: isDarkMode ? 'none' : 'solid 1px #CBD5E1'}}  />
            </Form.Item>
          </Col>
          <Col xs={24} sm={12} md={8}>
            <Form.Item name="descricao" label="Descrição">
              <Input placeholder="Buscar por descrição" allowClear style={{padding:7,background: isDarkMode ? '#171C2A' : '#fff', border: isDarkMode ? 'none' : 'solid 1px #CBD5E1'}} />
            </Form.Item>
          </Col>
