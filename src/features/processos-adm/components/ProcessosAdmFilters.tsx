        ...
        <Row gutter={[16, 0]}>
          <Col xs={24} sm={12} md={5}>
            <Form.Item name="codigo" label="Código">
              <Input style={{padding:'7px',background: isDarkMode ? '#171C2A' : '#fff', border: isDarkMode ? 'solid 1px #1E2A47' : 'solid 1px #CBD5E1'}} placeholder="PROC-XXXX" allowClear />
            </Form.Item>
          </Col>
          <Col xs={24} sm={12} md={6}>
            <Form.Item name="nomeCliente" label="Cliente">
              <Input style={{padding:'7px',background: isDarkMode ? '#171C2A' : '#fff', border: isDarkMode ? 'solid 1px #1E2A47' : 'solid 1px #CBD5E1'}} placeholder="Nome do cliente" allowClear />
            </Form.Item>
          </Col>
          ...
          <Col xs={24} sm={12} md={4}>
            <Form.Item name="nf" label="Nota Fiscal">
              <Input style={{padding:'7px',background: isDarkMode ? '#171C2A' : '#fff', border: isDarkMode ? 'solid 1px #1E2A47' : 'solid 1px #CBD5E1'}} placeholder="NF-XXXX" allowClear />
            </Form.Item>
          </Col>
          <Col xs={24} sm={24} md={5}>
            <Form.Item name="periodo" label="Período do Contrato">
              <RangePicker  style={{padding:'7px',background: isDarkMode ? '#171C2A' : '#fff', border: isDarkMode ? 'solid 1px #1E2A47' : 'solid 1px #CBD5E1'}} format="DD/MM/YYYY" />
            </Form.Item>
          </Col>
        </Row>
        <Row justify="end">
